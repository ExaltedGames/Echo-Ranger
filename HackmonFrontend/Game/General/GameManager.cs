...
using HackmonFrontend.Debugging;

namespace HackmonFrontend.Game.General;
...
public partial class GameManager : Node
{
	...
	public override void _Ready()
	{
		...
		if (CurrentScene is Battle.Battle)
			LoadTestBattleData();
	}
	...
	public void LoadTestBattleData()
	{
		...
		var playerMon = new HackmonInstance(HackmonManager.HackmonRegistry[0], 100);
		var enemyMon = new HackmonInstance(HackmonManager.HackmonRegistry[0], 25);
	...
	private void DeferredEnterBattle()
	{
		...
		var battleScene = BattleScene.Instantiate<Battle.Battle>();
